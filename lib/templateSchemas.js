...
export const PAGE_TEMPLATE_FIELDS = {
  homepage: [
    ...
    { name: 'categoryKicker', label: 'Category section label', type: 'text', localized: true },
    { name: 'categoryTitle', label: 'Category section title', type: 'text', localized: true },
    { name: 'categoryIntro', label: 'Category section intro', type: 'textarea', localized: true },
    { name: 'categoryCtaLabel', label: 'Category CTA label', type: 'text', localized: true },
    { name: 'categoryCtaHref', label: 'Category CTA URL', type: 'text' },
    ...
    { name: 'contactCtaSection', label: 'Contact CTA', type: 'section' },
...
export function getEffectivePageTemplate(page) {
  ...
  if (page?.slug === 'gift-finder') return 'gift-finder';
  return 'standard';
}

export function getTemplateField(fields = {}, name, lang = 'en', fallback = '') {
  fallback = t(fallback, lang);
